...
declare function useAnimate<T extends Element = any>(): [AnimationScope<T>, {
    (from: string, to: string | GenericKeyframesTarget<string>, options?: AnimateOptions<string> | undefined): AnimationPlaybackControls;
    (from: number, to: number | GenericKeyframesTarget<number>, options?: AnimateOptions<number> | undefined): AnimationPlaybackControls;
    (value: MotionValue<string>, keyframes: string | GenericKeyframesTarget<string>, options?: AnimateOptions<string> | undefined): AnimationPlaybackControls;
    (value: MotionValue<number>, keyframes: number | GenericKeyframesTarget<number>, options?: AnimateOptions<number> | undefined): AnimationPlaybackControls;
    <V>(value: ElementOrSelector, keyframes: DOMKeyframesDefinition, options?: AnimateOptions<V> | undefined): AnimationPlaybackControls;
}];
