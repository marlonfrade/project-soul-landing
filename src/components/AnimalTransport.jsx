import AnimalBg from '/src/assets/animal-transportation.jpeg'
import { motion } from 'framer-motion'
import useDeviceWidth from '/src/hooks/useDeviceWidth'

export default function AnimalTransport() {
  const isDesktop = useDeviceWidth()
  return (
    <div className="relative flex flex-col-reverse md:py-16 lg:pt-0 lg:flex-col lg:pb-0 md:mt-40">
      {isDesktop ? (
        <motion.div
        ...
        >
          ...
          <img
            ...
            src={AnimalBg}
            alt="Imagem de fundo do Transporte de proteína animal"
            loading="lazy"
          />
        </motion.div>
      ) : (
      ...
      <motion.div
        ...
        className="relative flex flex-col items-start w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:max-w-screen-2xl"
      >
        <div className="mb-16 lg:my-40 lg:max-w-xl lg:pr-5">
          ...
          <p className="pr-5 mb-5 text-base text-gray-700 dark:text-gray-100 md:text-lg">
            Trabalhamos com todo o cuidado e segurança para garantir que não
            ocorram incidentes durante o transporte, que possam alterar as
            características do produto, como sabor, cor, textura ou até mesmo
            reduzir o tempo de prateleira.
          </p>
        </div>
      </motion.div>
    </div>
